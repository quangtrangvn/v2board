window.settings.i18n['vi-VN'] = {
  ...
  '公告': 'Thông Báo',
  '总览': 'Tổng Quat',
  '该订阅长期有效': 'Gói này thời hạn vĩnh viễn',
  ...
  '订阅': 'Gói Dịch Vụ',
  '确定重置当前已用流量？': 'Bạn có chắc chắn đặt lại lưu lượng hiện tại được sử dụng không?',
  ...
  '已用流量将在 {reset_day} 日后重置': 'Sau {reset_day} ngày dung lượng sẽ được đặt lại',
  '已用流量已在今日重置': 'dung lượng được đặt lại ngày hôm nay',
  '重置已用流量': 'Đặt lại lưu lượng đã sử dụng',
  '查看节点状态': 'Xem trạng thái nút',
  '当前已使用流量达{rate}%': 'Lưu lượng sử dụng quá {rate}%',
  '节点名称': 'Tên node',
  ...
  '快速将节点导入对应客户端进行使用': 'Bạn phải mua gói rồi mới thao tác này',
  '对您当前的订阅进行续费': 'Gia hạn gói hiện tại',
  '对您当前的订阅进行购买': 'Mua gói mới',
  '捷径': 'Phím tắt',
  '不会使用，查看使用教程': 'Xem hướng dẫn sử dụng',
  ...
  '选择最适合你的计划': 'Chọn gói phù hợp với bạn',
  '全部': 'Tất cả',
  '按周期': 'Chu kỳ',
  '遇到问题': 'Tạo ticket hỗ trợ',
  '遇到问题可以通过工单与我们沟通': 'Nhắn vào nút trợ giúp ở góc web sẽ được hỗ trợ nhanh hơn ',
  '按流量': 'Vĩnh viễn',
